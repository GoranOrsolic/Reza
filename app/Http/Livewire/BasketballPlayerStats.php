...
class BasketballPlayerStats extends Component
{
    ...
    public function refresh()
    {
        ...
        $response = $client->get('https://sofasport.p.rapidapi.com/v1/seasons/players-statistics/result', [
            'headers' => [
    ...
    {
        return view('livewire.basketball-player-stats',[
