...
class BasketballDropdownComponent extends Component
{
    public $categories;
    ...
    public function mount()
    {
        $this->categories = Http::withHeaders([
            ...
            'sport_id' => 1,
        ])->get('https://sofasport.p.rapidapi.com/v1/categories?sport_id=2')->json('data');
    ...
    public function render()
    {
        ...
        return view('livewire.basketball-dropdown-component');
    }
}
