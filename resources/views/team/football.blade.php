                ...
                @foreach($dat as $info)
                    ...
                    <div class="d-flex flex-row align-items-center">
                        <div class="flex p-2 items-center bg-white rounded-xl shadow-xl mb-2">
                            <div>
                                <img src="{{ $base64 }}" alt="" width="112" height="112">
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="bg-white rounded-xl shadow-xl mb-2">
                            ...
                            <div class="flex justify-around">
                                ...
                                <div class="w-1/2">
                                    ...
                                    @foreach($nextMatch as $nMatch)
                                        <div class="flex items-center p-2">
                                            {{--
                                                                                                    <img class="mr-4" src="data:image/png;base64,{{ $tournamentLogo }}" alt="Tournament Logo" width="24" height="24">
                                            --}}
                                            {{ $nMatch['nextEvent']['tournament']['category']['name'] }},
                                            {{ $nMatch['nextEvent']['tournament']['name'] }},
                                            Round {{ $nMatch['nextEvent']['roundInfo']['round'] }}
                                        </div>
                                        ...
                                        <div class="flex justify-between pt-2">
                                            ...
                                            <div class="flex flex-col items-center mx-2 justify-center">
                                                <span>{{ \Carbon\Carbon::parse($nMatch['nextEvent']['startTimestamp'])->format('d/m/Y') }}</span>
                                                <span>{{ \Carbon\Carbon::parse($nMatch['nextEvent']['startTimestamp'])->format('H:i') }}</span>
                                            </div>
                            ...
                            <div class="w-1/2 border-r border-gray-400">
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div>{{\Carbon\Carbon::parse($info['foundationDateTimestamp'])->format('d/m/Y')}}</div>
                                    </div>
